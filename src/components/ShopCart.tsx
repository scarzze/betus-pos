...
import { X, ShoppingCart, Trash2, ArrowRight, Phone, Mail, MapPin, User, Loader2, CheckCircle2, ShieldCheck, Timer, AlertCircle } from 'lucide-react';
            ...
            <div className="h-full flex flex-col items-center justify-center text-center animate-fade-in p-4">
               {mpesaStage === 'success' ? (
                 <div className="animate-scale-in">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tighter">Authorized</h2>
                    <p className="text-emerald-400/60 font-medium text-sm md:text-base mb-8 md:mb-12">{mpesaStatusMsg}</p>
                 </div>
               ) : (
                 <>
                    ...
                    <h2 className="text-2xl md:text-3xl font-black mb-4 uppercase tracking-tighter leading-none">
